...
def get_arguments():
    ...
    parser.add_argument("--pesudo_datasets",  nargs='*', type=str, default=['DFC18'], help="target datasets list used for generate pesudo labels")
    parser.add_argument("--use_ground_mask", action="store_true", help="rectify pesudo dsm or not")
    parser.add_argument("--pesudo_threshold", type=float, default=0.95, help="pesudo land cover confidence threshold")
    parser.add_argument("--pesudo_dsm_threshold", type=float, default=1.55, help="pesudo dsm consistency threshold")
    ...
    parser.add_argument("--src_strong", action="store_true", help="use strong transform on src or not")
    ...
    parser.add_argument("--warmss", type=int, default=0, help="Number of ss confidence warm-up steps.")
